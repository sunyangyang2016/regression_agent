...
用户需求 → 提取三要素：
- **年级**：二年级 / 一年级 / 学前班 / 大班 / 中班 / 小班
- **科目**：数学 / 语文 / 英语 / 科学 / 艺术 / 健康
- **关键词**：`年级 + 科目 + 教学视频` 组合，如 `大班 数学 教学视频`

> ★ 年级规范（2026-08-15）：关键词/来源元数据里的「幼儿」「幼小」「幼小衔接」统一归属 **小班**；「幼儿园」泛称归属 **学前班**（guess_metadata 自动规范化，无需手工区分）。
> ★ 科目规范（2026-08-15）：**拼音 / 识字 / 古诗（含诗词）归属 语文；儿歌 归属 艺术**（guess_metadata 自动规范化）。
